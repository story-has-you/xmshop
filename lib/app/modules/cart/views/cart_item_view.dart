  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        border: Border(bottom: BorderSide(color: Color.fromARGB(178, 240, 236, 236), width: ScreenAdapter.height(2))),
      ),
      child: Row(
        children: [
          SizedBox(
          ...
          Expanded(
            ...
            children: [
              ...
              Row(
                ...
                children: [Text("¥98.9", style: TextStyle(fontSize: ScreenAdapter.fontSize(38), color: Colors.red)), const CartItemNumView()],
              )
            ],
          ))
        ],
