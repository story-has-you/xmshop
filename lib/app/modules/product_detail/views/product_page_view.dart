                        ...
                        Wrap(
                          children: [
                            Container(
                              ...
                              child: const Text("版本", style: TextStyle(fontWeight: FontWeight.bold)),
                            ),
                            Container(
                              padding: EdgeInsets.only(top: ScreenAdapter.height(20), left: ScreenAdapter.width(20)),
                              width: ScreenAdapter.width(1040),
                              child: Wrap(
                                children: [
                                  Container(
                                    ...
                                    child: Chip(padding: EdgeInsets.only(left: ScreenAdapter.width(20), right: ScreenAdapter.width(20)), backgroundColor: const Color.fromARGB(31, 223, 213, 213), label: const Text("8GB+128GB")),
                                  ),
                                  Container(
                                    margin: EdgeInsets.all(ScreenAdapter.width(20)),
                                    child: Chip(padding: EdgeInsets.only(left: ScreenAdapter.width(20), right: ScreenAdapter.width(20)), backgroundColor: const Color.fromARGB(31, 223, 213, 213), label: const Text("16GB+256GB")),
                                  ),
                                  Container(
                                    margin: EdgeInsets.all(ScreenAdapter.width(20)),
                                    child: Chip(padding: EdgeInsets.only(left: ScreenAdapter.width(20), right: ScreenAdapter.width(20)), backgroundColor: const Color.fromARGB(31, 223, 213, 213), label: const Text("8GB+128GB")),
